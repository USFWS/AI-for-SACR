...
data1 <- read.table ("predict_sacr_2023_17a_c.csv", sep = ",",header=TRUE, fill=TRUE)
...
export_spatial = "SACR_pred_2025_17a_c.shp"
...
new_sf <- st_as_sf(data1, coords = c("x_annot", "y_annot_above"), crs= crs1)
