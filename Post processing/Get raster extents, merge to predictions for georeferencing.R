...
setwd(file.path('D:', 'SACR', '2_2023_mosaics_new'))
...
pred1 <- read.table ("mosaic17a_c_2023.csv", sep = ",", header=TRUE, fill=TRUE)

output_csv = "mosaics17a_c_2023_step2.csv"
...
write.table(merge5, output_csv, sep=",", row.names=FALSE)
